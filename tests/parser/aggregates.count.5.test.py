...
%:- #count{V:a(M),b(N),c(M,V)} = 3. [1:1]           

:- #count{V:a(M),b(N),c(M,V)} < 2.           
%:- #count{V:a(M),b(N),c(M,V)} < 2. [1:1] 
   
:- #count{V:a(M),b(N),c(M,V)} <= 1.          
%:- #count{V:a(M),b(N),c(M,V)} <= 1. [1:1]          
...
%:- p(M), #count{V:a(M),b(N),c(M,V)} = 3. [1:1]           

:- p(M), #count{V:a(M),b(N),c(M,V)} < 2.           
%:- p(M), #count{V:a(M),b(N),c(M,V)} < 2. [1:1] 
   
:- p(M), #count{V:a(M),b(N),c(M,V)} <= 1.          
%:- p(M), #count{V:a(M),b(N),c(M,V)} <= 1. [1:1]          
...
%:- #count{V:a(M),b(N),c(M,V)} = 3, p(M). [1:1]         

:- #count{V:a(M),b(N),c(M,V)} < 1, p(M).
%:- #count{V:a(M),b(N),c(M,V)} < 1, p(M). [1:1]           

:- #count{V:a(M),b(N),c(M,V)} <= 1, p(M). 
%:- #count{V:a(M),b(N),c(M,V)} <= 1, p(M). [1:1]          

:- #count{V:a(M),b(N),c(M,V)} > 2, p(M). 
%:- #count{V:a(M),b(N),c(M,V)} > 2, p(M). [1:1]          
...
%:- 1 = #count{V:a(M),b(N),c(M,V)}. [1:1]  
 
:- 3 < #count{V:a(M),b(N),c(M,V)}.           
%:- 3 < #count{V:a(M),b(N),c(M,V)}. [1:1]
...
%:- q(N), 1 = #count{V:a(M),b(N),c(M,V)}. [1:1]  
 
:- q(N), 3 < #count{V:a(M),b(N),c(M,V)}.           
%:- q(N), 3 < #count{V:a(M),b(N),c(M,V)}. [1:1]
...
%:- 1 = #count{V:a(M),b(N),c(M,V)}, q(N). [1:1]   

:- 3 < #count{V:a(M),b(N),c(M,V)}, q(N).         
%:- 3 < #count{V:a(M),b(N),c(M,V)}, q(N). [1:1]         
...
%:- 2 < #count{V:a(M),b(N),c(M,V)} < 3. [1:1]

%:- 2 < #count{V:a(M),b(N),c(M,V)} < 3, q(N). [1:1]     
...
%:- p(M), 2 < #count{V:a(M),b(N),c(M,V)} <= 3. [1:1]
...
%:- 3 <= #count{V:a(M),b(N),c(M,V)} < 4. [1:1]     

%:- p(M), 3 <= #count{V:a(M),b(N),c(M,V)} < 4. [1:1]

%:- 3 <= #count{V:a(M),b(N),c(M,V)} < 4, q(N). [1:1]
