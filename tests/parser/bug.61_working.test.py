...
%:- etaErrata(X1,_), Parentela(X1,P1), Eta(X2,Y), Parentela(X2,P2), etaMedia(EM,P1,Y,P2), Eta(X1,E1), E1>EM, D=E1-EM. [D:1]

%:- etaErrata(X1,_), Parentela(X1,P1), Eta(X2,Y), Parentela(X2,P2), etaMedia(Y,P2,EM,P1), Eta(X1,E1), E1>EM, D=E1-EM. [D:1]

%:- etaErrata(X1,_), Parentela(X1,P1), Eta(X2,Y), Parentela(X2,P2), etaMedia(EM,P1,Y,P2), Eta(X1,E1), EM>E1, D=EM-E1. [D:1]

%:- etaErrata(X1,_), Parentela(X1,P1), Eta(X2,Y), Parentela(X2,P2), etaMedia(Y,P2,EM,P1), Eta(X1,E1), EM>E1, D=EM-E1. [D:1]
