 ...
 *
 * Created on 29 agosto 2014, 22.33
 */

#ifndef DBNAMESTABLE_H
#define	DBNAMESTABLE_H
...
namespace DLV2{ namespace DB{
    ...
    public:
        ...
        DBNamesTable( index_t startIndex = 0 );
        DBNamesTable( const DBNamesTable< T >& n2 );

        DBNamesTable& operator=( const DBNamesTable< T >& n2 );
...
template < typename T >
typename DLV2::DB::DBNamesTable< T >::const_iterator& 
DLV2::DB::DBNamesTable< T >::const_iterator::operator=(
...
template < typename T >
DLV2::DB::DBNamesTable< T >::DBNamesTable( 
    index_t startIndex ): 
        lookup(), 
        indexed(), 
...
template < typename T >
DLV2::DB::DBNamesTable< T >::DBNamesTable( 
    const DLV2::DB::DBNamesTable< T >& n2 ): 
        lookup(n2.lookup),
        indexed(n2.indexed),
...
template < typename T >
DLV2::DB::DBNamesTable< T >&
DLV2::DB::DBNamesTable< T >::operator=(
    const DLV2::DB::DBNamesTable< T >& n2 )
{
    // These tables should not be copied.
...
template < typename T >
std::pair< DLV2::DB::index_t, bool >
DLV2::DB::DBNamesTable< T >::find(
    const T &item ) const
{
...
template < typename T >
const T&
DLV2::DB::DBNamesTable< T >::getItem(
    DLV2::DB::index_t index ) const
{
...
template < typename T >
std::pair< DLV2::DB::index_t, bool >
DLV2::DB::DBNamesTable< T >::getIndex(
    const T& item ) const
{
